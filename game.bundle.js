/* game.bundle.js — BUILT ARTIFACT (do not edit). Run `node build.js` after editing src/ modules. v1.5.0 */
...
function render(){
  ...
  drawParticles();
  drawWeather(bg);
  present();   // upscale the low-res buffer to the display canvas (nearest-neighbor)
}
function loop(){
  update();
  render();
